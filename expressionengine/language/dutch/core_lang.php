...
'generic_fatal_error' => 
'Er is iets mis gegaan en deze URL kan op dit moment niet verwerkt worden',
...
'csrf_token_expired' => 
'Het formulier is verlopen. Ververs de pagina en probeer opnieuw.',

'current_password_required' => 
'Uw huidige wachtwoord is vereist',

'current_password_incorrect' => 
'Uw huidige wachtwoord is onjuist opgegeven.',
...
'Your cache folder does not have proper permissions. To fix: Set the cache folder (/expressionengine/cache/) permissions to 777 (or equivalent for your server).	',

'unwritable_config_file' => 
'Your configuration file does not have the proper permissions. To fix: Set the config file (/expressionengine/config/config.php) permissions to 666 (or equivalent for your server).',

'redirect_xss_fail' => 
'The link you are being redirected to contained some potentially malicious or dangerous code. We recommend you hit the back button and email %s to report the link that generated this message.',
...
'Controleer of de &#39;%x&#39; module geïnstalleerd is en dat &#39;%y&#39; een beschikbare methode van de module is',

'template_loop' => 
'Er is een loop ontstaan in uw template door verkeerd genestte sub-templates (&#39;%s&#39; recursief opgeroepen)',

'template_load_order' => 
'Template laad-volgorde',
